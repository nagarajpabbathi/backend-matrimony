...
const createBiodata = async (req, res, next) => {
    ...
    upload(req, res, err => {
        if (err) {
            ...
            var search = req.body.gender.substring(0, 1) + req.body.qualify.substring(0, 2) + req.body.caste.substring(0, 2) + req.body.jobtype.substring(0, 1) + req.body.dob.substring(0, 4) 
